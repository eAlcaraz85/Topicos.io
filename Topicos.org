...
*** Ejercicio Práctico
Realiza las siguientes operaciones como práctica para consolidar los conceptos:

1. Conéctate a una base de datos y crea una tabla llamada "productos" con campos `id`, `nombre`, `precio`, y `cantidad`.
2. Inserta algunos productos en la tabla.
3. Consulta todos los productos con un precio mayor a un valor específico.
4. Actualiza la cantidad de uno de los productos.
5. Elimina un producto de la tabla.
6. Cierra la conexión.

*** Conclusión
Este manual te ofrece una guía básica para el manejo de bases de datos en Python. Puedes aplicar estas técnicas a diferentes sistemas de bases de datos con pequeñas adaptaciones en las conexiones y las consultas. Consulta la documentación específica de cada biblioteca para funcionalidades avanzadas, como transacciones y manejo de errores.
