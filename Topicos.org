...
*** 1. Archivos JSON
*** 1.1 ¿Qué es JSON?
JSON (JavaScript Object Notation) es un formato ligero para el intercambio de datos. Es fácil de leer y escribir tanto para humanos como para máquinas. Aunque tiene sus raíces en JavaScript, es un formato independiente del lenguaje y ampliamente utilizado, especialmente en APIs y aplicaciones web.
